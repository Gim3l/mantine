...
In the example above, the `rule` function is used to determine which value should be used initially:
...
Now you can use your component as a controlled and uncontrolled input:
